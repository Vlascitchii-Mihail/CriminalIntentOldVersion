...
//        Log.d(TAG, "args bundle crime ID: $crimeId")
    ...
    override fun onStart() {
        ...
        suspectButton.apply {
            ...
            //if the device doesn't have any contact app, the suspect button will be disabled
            val selectSuspectIntent = pickContact.contract.createIntent(requireContext(), null)
            isEnabled = canResolveIntent(selectSuspectIntent)
...
//        }
        ...
        photoButton.apply {
            ...
            //if the device doesn't have a camera, the button won't be enable
//            val cameraIntent = pickCamera.contract.createIntent(requireContext(), null)
...
//        )
        ...
        val appSettingsIntent = pickContact.contract.createIntent(requireContext(), null)

        //checking exists any activity for handling the intent
        /**
...
//            Toast.makeText(requireContext(), "Permissions are denied forever", Toast.LENGTH_SHORT).show()
//        }
        if (canResolveIntent(appSettingsIntent)) {
            Toast.makeText(requireContext(), "Permissions are denied forever", Toast.LENGTH_SHORT).show()
        }
        else {
    ...
    private fun getContactNameAndID(contactUri: Uri) {
        ...
        cursorNameAndId?.use {
            ...
            if(it.count > 0) {
                ...
                //moveToFirst() - moving the cursor to the first string
                it.moveToFirst()
...
//        )
        ...
        val appSettingsIntent = pickCamera.contract.createIntent(requireActivity(), null)
...
//    }
    ...
    /**
     *  checking if the activity exists, returns ResolveInfo or null
     */
